            ...
            <div class="container pb-5 bg-light" style="width: 70%;">
                <div class="row">
                    <div class="col-lg-5 mt-5">
                        <div class="card mb-3">
                            <img class="card-img img-fluid" src="../vista_corp/assets/img/arroz.jpg" alt="Card image cap"
                                id="product-detail">
                        </div>
                        <div class="row">
                            <!--Start Controls-->
                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="../vista_corp/assets/img/2Face_arroz.jpg"
                                                        alt="Product Image 2">
                                                </a>
                                            </div>
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="../vista_corp/assets/img/3face_arroz.png"
                                                        alt="Product Image 3">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="../vista_corp/assets/img/4face_arroz.png"
                                                        alt="Product Image 4">
                                                </a>
                                            </div>
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="../vista_corp/assets/img/5face_arroz.png"
                                                        alt="Product Image 5">
                                                </a>
                                            </div>
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="../vista_corp/assets/img/6face_arroz.png"
                                                        alt="Product Image 6">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid"
                                                        src="../vista_corp/assets/img/ultimaface_arroz.png " alt="Product Image 8">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
