        ...
        <form action="../../controladores/admin/registrar_admin.php" method="POST" onsubmit="return validarContraseña()">
            ...
            <div class="form-floating mb-3" style="margin-top:15px;">
                <input name="identificacion" type="text" class="form-control cuadro_texto1" id="identificacion"
                    placeholder="Identificacion" required maxlength="11">
            ...
            <div class="campos">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:0px !important;">
                    <input name="nombre2" type="text" class="form-control cuadro_texto1" id="nombre2"
                        placeholder="nombre2" maxlength="50">
            ...
            <div class="campos">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:0px !important;">
                    <input name="apellido2" type="text" class="form-control cuadro_texto1" id="apellido2"
                        placeholder="apellido2" maxlength="50">
            ...
            <div class="campos">
                ...
                <div class="form-floating mb-3" style="margin-top: 3%;">
                    <input name="telefono" type="text" class="form-control cuadro_texto1" id="telefono"
                        placeholder="telefono" required maxlength="15">
            ...
            <div class="campos">
                ...
                <div class="form-floating mb-3 campo_intermedio" style="margin-top: 3%;">
                    <input name="direccion" type="text" class="form-control cuadro_texto1" id="direccion"
                        placeholder="direccion" required maxlength="50">
            ...
            <button type="submit" class="submit" id="guardar" name="guardar_admin">Guardar</button>
        </form>
    </div>
