    ...
    <div id="form-container">
        ...
        <form action="../../controladores/admin/modificar_admin.php" method="POST">
            ...
            <div class="form-floating mb-3" style="margin-top:15px;">
                <input name="identificacion" type="number" class="form-control cuadro_texto1" id="identificacion" placeholder="Identificacion" value="<?= $row['identificacion']?>" readonly required>
            ...
            <div style="display:grid; grid-template-columns: repeat(2,1fr) ;">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:0px !important;">
                    <input name="nombre2" type="text" class="form-control cuadro_texto1" id="nombre2" placeholder="nombre2" value="<?= $row['segundo_nombre']?>" maxlength="50">
            ...
            <div style="display:grid; grid-template-columns: repeat(2,1fr) ;">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:0px !important;">
                    <input name="apellido2" type="text" class="form-control cuadro_texto1" id="apellido2" placeholder="apellido2" value="<?= $row['segundo_apellido']?>" maxlength="50">
            ...
            <div style="display:grid; grid-template-columns: repeat(2,1fr) ;">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:5% !important;">
                    <input name="telefono" type="text" class="form-control cuadro_texto1" id="telefono" placeholder="telefono" value="<?= $row['telefono']?>" required>
            ...
            <div style="display:grid; grid-template-columns: repeat(2,1fr); margin-bottom:5%;">
                ...
                <div class="form-floating mb-3" style="margin-top:15px; margin-bottom:0px !important;">
                    <input name="usuario" type="text" class="form-control cuadro_texto1" id="usuario" placeholder="usuario" value="<?= $row['usuario']?>" required>
