            ...
            <div class="modal-body">
                <div class="z-flex2">
                    ...
                    <form method="POST" action="<?php  echo $_SERVER['PHP_SELF'];?>">
                        <img src="/agrocosecha_final/vista_corp/assets/img/logomaiz1.png" class="col-sm-6"
                            id="ini_logo3" style="margin-top: -14%">
                        <h5 class="modal-title" id="exampleModalToggleLabel" style="margin-bottom: 5%; color: #065F2C;">
                            Iniciar sesión</h5>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control cuadro_texto2" id="floatingInputUsuario"
                                name="usuario" placeholder="usuario">
                            <label for="floatingInputUsuario">Usuario</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control cuadro_texto2" id="floatingInputcontraseña"
                        ...
                        <div style="display:grid; grid-template-columns: repeat(1, 1fr);">
                            <button type="submit" class="btn-iniciar2" style="padding:1% 5%; margin-bottom:5%;">Iniciar
                                sesión</button>
                            <button type="submit" class="btn-iniciar2" data-bs-toggle="modal" data-bs-target="#registro"
                                data-bs-dismiss="modal" style="padding:1% 5%;">Registrarse</button>
                        </div>
                    </form>
                    <!-- fin del formulario  -->
            ...
            <div class="modal-body">
                <form action="/agrocosecha_final/vista_corp/assets/controladores/cliente/registrar_usuario.php"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cuadro_texto2" id="nombre" placeholder="nombre"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cuadro_texto2" id="nombre2" placeholder="nombre2"
                                    name="nombre2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cuadro_texto2" id="correo2" placeholder="correo"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <select id="sexo" name="sexo" class="form-select cuadro_texto2"
                                    aria-label="Seleccione el Sexo">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control cuadro_texto2" id="fecha_nacimiento"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cuadro_texto2" id="direccion"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control cuadro_texto2" id="usuario" placeholder="usuario"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control cuadro_texto2" id="contraseña"
