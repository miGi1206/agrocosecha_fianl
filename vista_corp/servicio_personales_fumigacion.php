                    ...
                    <div class="col-lg-7 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="h4">Fumigación</h3>

                                <?php include "../vista_corp/assets/controladores/servicios.php";?>

                                <h6>Description:</h6>
                                <p>
                                    Con gran satisfacción, nos complace presentar nuestros servicios personalizados de
                                    fumigación, diseñados para brindar soluciones efectivas y seguras en el control de
                                    plagas, adaptados a las necesidades específicas de cada cliente. Comprometidos con
                                    la calidad y la responsabilidad ambiental, nuestro equipo de expertos utiliza
                                    métodos cuidadosamente seleccionados para garantizar un manejo eficiente de las
